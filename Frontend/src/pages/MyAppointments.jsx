...
const MyAppointments = () => {
    ...
    // Grabbing the doctors array from our context to use as fake booking data
    ...
    return (
        <div>
            ...
            <div>
                {/* Slicing the first 3 doctors to act as our "booked" appointments */}
                {doctors.slice(0, 3).map((item, index)=>(
                    <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
                        ...
                        {/* Doctor Info & Fake Appointment Time */}
