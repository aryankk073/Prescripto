...
const Appointment = () => {
    ...
    // --- NEW FUNCTION: GENERATE 7 DAYS OF SLOTS ---
    const getAvailableSlots = async () => {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            endTime.setHours(21, 0, 0, 0) // slots end at 9:00 PM
    ...
    // --- NEW USEEFFECT: TRIGGER SLOT GENERATION WHEN DOCINFO LOADS ---
    useEffect(() => {
        if (docInfo) {
            getAvailableSlots()
        }
